...
80106cf4:	bf f4 54 11 80       	mov    $0x801154f4,%edi
80106cf9:	56                   	push   %esi
80106cfa:	53                   	push   %ebx
80106cfb:	83 ec 2c             	sub    $0x2c,%esp
80106cfe:	8b 5d 08             	mov    0x8(%ebp),%ebx
...
80106d0d:	e9 b2 00 00 00       	jmp    80106dc4 <shm_open+0xd4>
...
80106d18:	89 1f                	mov    %ebx,(%edi)
      //allocate a new physical page and store its address page.frame=kalloc()
      shm_table.shm_pages[i].frame = kalloc();
80106d1a:	e8 91 b7 ff ff       	call   801024b0 <kalloc>
      //increment the refcnt
      shm_table.shm_pages[i].refcnt++;
      //initialize the grame allocated to 0 (use memset())
      memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106d1f:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d26:	00 
80106d27:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106d2e:	00 
      shm_table.shm_pages[i].refcnt++;
80106d2f:	83 47 08 01          	addl   $0x1,0x8(%edi)
      memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106d33:	89 04 24             	mov    %eax,(%esp)
      shm_table.shm_pages[i].frame = kalloc();
80106d36:	89 47 04             	mov    %eax,0x4(%edi)
      memset(shm_table.shm_pages[i].frame, 0, PGSIZE);
80106d39:	e8 52 d5 ff ff       	call   80104290 <memset>
...
80106d3e:	8b 47 04             	mov    0x4(%edi),%eax
80106d41:	05 00 00 00 80       	add    $0x80000000,%eax
80106d46:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106d49:	e8 62 c9 ff ff       	call   801036b0 <myproc>
80106d4e:	8b 08                	mov    (%eax),%ecx
80106d50:	8d b1 ff 0f 00 00    	lea    0xfff(%ecx),%esi
80106d56:	e8 55 c9 ff ff       	call   801036b0 <myproc>
80106d5b:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106d5e:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106d64:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d6b:	00 
80106d6c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106d73:	00 
80106d74:	89 74 24 04          	mov    %esi,0x4(%esp)
80106d78:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106d7c:	8b 40 04             	mov    0x4(%eax),%eax
80106d7f:	89 04 24             	mov    %eax,(%esp)
80106d82:	e8 c9 f7 ff ff       	call   80106550 <mappages>
      //return the address of the page through the pointer variable *pointer = (char*) size;
      *pointer = (char*)PGROUNDUP(myproc()->sz);
80106d87:	e8 24 c9 ff ff       	call   801036b0 <myproc>
80106d8c:	8b 55 0c             	mov    0xc(%ebp),%edx
80106d8f:	83 c7 0c             	add    $0xc,%edi
80106d92:	8b 00                	mov    (%eax),%eax
80106d94:	05 ff 0f 00 00       	add    $0xfff,%eax
80106d99:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106d9e:	89 02                	mov    %eax,(%edx)
      //update current process size
      myproc()->sz = PGROUNDUP(myproc()->sz + PGSIZE);
80106da0:	e8 0b c9 ff ff       	call   801036b0 <myproc>
80106da5:	89 c6                	mov    %eax,%esi
80106da7:	e8 04 c9 ff ff       	call   801036b0 <myproc>
80106dac:	8b 08                	mov    (%eax),%ecx
80106dae:	81 c1 ff 1f 00 00    	add    $0x1fff,%ecx
80106db4:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  for(i=0; i < 64; i++) {
80106dba:	81 ff f4 57 11 80    	cmp    $0x801157f4,%edi
      myproc()->sz = PGROUNDUP(myproc()->sz + PGSIZE);
80106dc0:	89 0e                	mov    %ecx,(%esi)
  for(i=0; i < 64; i++) {
80106dc2:	74 5c                	je     80106e20 <shm_open+0x130>
    if(id == shm_table.shm_pages[i].id) { //if found
80106dc4:	3b 1f                	cmp    (%edi),%ebx
80106dc6:	0f 85 4c ff ff ff    	jne    80106d18 <shm_open+0x28>
      mappages(myproc()->pgdir, (char*)PGROUNDUP(myproc()->sz), PGSIZE, V2P(shm_table.shm_pages[i].frame), PTE_W|PTE_U);
80106dcc:	8b 47 04             	mov    0x4(%edi),%eax
80106dcf:	05 00 00 00 80       	add    $0x80000000,%eax
80106dd4:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106dd7:	e8 d4 c8 ff ff       	call   801036b0 <myproc>
80106ddc:	8b 08                	mov    (%eax),%ecx
80106dde:	8d b1 ff 0f 00 00    	lea    0xfff(%ecx),%esi
80106de4:	e8 c7 c8 ff ff       	call   801036b0 <myproc>
80106de9:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106dec:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
80106df2:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106df9:	00 
80106dfa:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80106e01:	00 
80106e02:	89 74 24 04          	mov    %esi,0x4(%esp)
80106e06:	89 54 24 0c          	mov    %edx,0xc(%esp)
80106e0a:	8b 40 04             	mov    0x4(%eax),%eax
80106e0d:	89 04 24             	mov    %eax,(%esp)
80106e10:	e8 3b f7 ff ff       	call   80106550 <mappages>
      shm_table.shm_pages[i].refcnt++;
80106e15:	83 47 08 01          	addl   $0x1,0x8(%edi)
80106e19:	e9 69 ff ff ff       	jmp    80106d87 <shm_open+0x97>
80106e1e:	66 90                	xchg   %ax,%ax
  ...
  //release lock
  release(&(shm_table.lock));
80106e20:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e27:	e8 14 d4 ff ff       	call   80104240 <release>
...
80106e56:	b8 f4 54 11 80       	mov    $0x801154f4,%eax
80106e5b:	eb 0d                	jmp    80106e6a <shm_close+0x2a>
80106e5d:	8d 76 00             	lea    0x0(%esi),%esi
80106e60:	83 c0 0c             	add    $0xc,%eax
  //loop through all 64 pages in shm_table...
  for(i=0; i<64; i++) {
80106e63:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e68:	74 26                	je     80106e90 <shm_close+0x50>
    //...and search if there exists a page whose id is same as id given as an argument
    if(shm_table.shm_pages[i].id == id) {
80106e6a:	39 18                	cmp    %ebx,(%eax)
80106e6c:	75 f2                	jne    80106e60 <shm_close+0x20>
      //if found
      if(shm_table.shm_pages[i].refcnt != 0) { //and refcnt is not 0
80106e6e:	8b 50 08             	mov    0x8(%eax),%edx
80106e71:	85 d2                	test   %edx,%edx
80106e73:	75 33                	jne    80106ea8 <shm_close+0x68>
        //decrement refcnt
        shm_table.shm_pages[i].refcnt--;
      }
      if(shm_table.shm_pages[i].refcnt == 0) { //if refcnt is 0
        ...
        shm_table.shm_pages[i].id = 0;
80106e75:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
80106e7b:	83 c0 0c             	add    $0xc,%eax
        shm_table.shm_pages[i].frame = 0;
80106e7e:	c7 40 f8 00 00 00 00 	movl   $0x0,-0x8(%eax)
  for(i=0; i<64; i++) {
80106e85:	3d f4 57 11 80       	cmp    $0x801157f4,%eax
80106e8a:	75 de                	jne    80106e6a <shm_close+0x2a>
80106e8c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  //release lock
  release(&(shm_table.lock));
80106e90:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106e97:	e8 a4 d3 ff ff       	call   80104240 <release>



return 0; //added to remove compiler warning -- you should decide what to return
}
80106e9c:	83 c4 14             	add    $0x14,%esp
...
80106ea4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
        shm_table.shm_pages[i].refcnt--;
80106ea8:	83 ea 01             	sub    $0x1,%edx
      if(shm_table.shm_pages[i].refcnt == 0) { //if refcnt is 0
80106eab:	85 d2                	test   %edx,%edx
        shm_table.shm_pages[i].refcnt--;
80106ead:	89 50 08             	mov    %edx,0x8(%eax)
      if(shm_table.shm_pages[i].refcnt == 0) { //if refcnt is 0
80106eb0:	75 ae                	jne    80106e60 <shm_close+0x20>
80106eb2:	eb c1                	jmp    80106e75 <shm_close+0x35>
